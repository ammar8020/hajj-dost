...
//    Circle mCircle;
    ...
    private TextView textLat, textLong, tvTawaf, tvCircuit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTawaf = findViewById(R.id.twaaf);
        tvCircuit = findViewById(R.id.circuit);
...
//        circle();
    ...
    public void onMapClick(LatLng latLng) {
        ...
        Log.d(TAG, "onMarkerClick: SelectedMarker markerLatitude: " + markerLatitude
...
//                mCircle.getCenter().latitude, mCircle.getCenter().longitude, distance);
            ...
            Location.distanceBetween(location.getLatitude(), location.getLongitude(),
                    markerLatitude, markerLongitude, distance);

            Log.d(TAG, "onLocationChanged: distance: " + distance[0]);
...
//            startActivity(i);
                ...
                if (flag) {
                    ...
                    Toast.makeText(this, "Circuit Count: " + counter, Toast.LENGTH_SHORT).show();

                    tvCircuit.setText("Circuit Count: " + counter);
...
//                    Toast.makeText(this, "Tawaf Count: " + tawafCount, Toast.LENGTH_SHORT).show();

                        Snackbar.make(findViewById(R.id.myCoordinatorLayout), "Tawaf Count: " + tawafCount,
                                Snackbar.LENGTH_SHORT)
                                .show();

                        tvTawaf.setText("Tawaf Count: " + tawafCount);
...
//
//
//        Log.d(TAG, "markerLocation: markerLatitude: " + markerLatitude
//                + " markerLongitude: " +  markerLongitude);
    }
...
//                .center(new LatLng(33.621606400000005, -73.0710016))
